...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Yes, and calling is the fastest way to get on the schedule. Juan answers personally and can typically get you scheduled within a few days. You can also submit a request through the contact form on this page and we will follow up promptly to confirm.',
  },
];

...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Yes, and calling is the fastest way to get on the schedule. Stephen answers personally and can typically get you scheduled within a few days. You can also submit a request through the contact form on this page and we will follow up promptly to confirm.',
  },
];
  ...
  return (
    <div className={`rounded-xl overflow-hidden border transition-all duration-200 ${open ? 'border-brand-200 shadow-sm' : 'border-neutral-200'}`}>
      ...
      >
        ...
        <ChevronDown
          className={`w-5 h-5 flex-shrink-0 transition-transform duration-200 ${open ? 'rotate-180 text-brand-500' : 'text-neutral-400'}`}
          aria-hidden="true"
        />
      </button>
      <div
  ...
  return (
    <section className="py-20 sm:py-28 bg-white">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-neutral-500 text-sm mb-2">Have a question that is not listed here?</p>
          <p className="text-neutral-400 text-sm mb-6">A quick call is the fastest way to get a straight answer about your specific situation.</p>
          ...
          <p className="text-neutral-400 text-xs mt-3">No pressure, just a clear plan</p>
        </div>
      </div>
    </section>
  );

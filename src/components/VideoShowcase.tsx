  ...
  return (
    <div className={`bg-white rounded-3xl overflow-hidden border border-neutral-200 shadow-md mb-10 reveal ${visible ? 'reveal-visible' : ''}`}>
      ...
      <div className="flex items-center gap-3 px-7 pt-6 pb-4 border-b border-neutral-100">
        ...
        <span className="text-neutral-600 text-xs font-medium">Commercial Transformation</span>
      </div>
      ...
      <div className="px-7 py-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p className="text-neutral-700 text-sm leading-relaxed max-w-2xl">{featuredVideo.description}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className={`bg-white rounded-2xl overflow-hidden border border-neutral-200 shadow-sm video-card-hover flex flex-col reveal ${delayClasses[index]} ${parentVisible ? 'reveal-visible' : ''}`}>
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <p className="text-neutral-700 text-sm leading-relaxed flex-1">{video.description}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <section id="gallery" className="py-20 sm:py-28 bg-neutral-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-neutral-700 text-base mb-1">Every job is done by the same person you speak with on the phone.</p>
          <p className="text-neutral-600 text-sm">Here is what that means for the homeowners we work with.</p>
        </div>
      </div>
    </section>
  );

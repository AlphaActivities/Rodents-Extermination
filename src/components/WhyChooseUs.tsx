...
const reasons = [
  {
    icon: UserCheck,
    title: 'Hands-On Work',
    description: 'Stephen Guerrero works every job personally. You are not dealing with a crew you have never met. The person you talk to is the person doing the work.',
  },
  {
    icon: DollarSign,
    title: 'Fair Pricing',

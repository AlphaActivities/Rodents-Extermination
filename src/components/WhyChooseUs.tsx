      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="relative pb-10 pr-10">
              ...
              <div className="absolute bottom-0 right-0 bg-white rounded-2xl border border-neutral-200 shadow-xl p-5 w-[180px]">
                ...
                <div className="text-neutral-600 text-xs">Attic focused. Owner-operated.</div>
              </div>
            </div>
          </div>
          ...
          <div>
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-neutral-700 text-xs leading-relaxed">{reason.description}</p>
                    </div>
                  </div>
                );
              })}
            ...
            <p className={`text-neutral-600 text-xs mt-3 reveal reveal-delay-1 ${ctaVisible ? 'reveal-visible' : ''}`}>
            ...
            <div className={`mt-10 pt-8 border-t border-neutral-200 reveal reveal-delay-2 ${ctaVisible ? 'reveal-visible' : ''}`}>
              <p className="text-neutral-700 text-sm">Do not just take our word for it. Here is what customers in DFW say after the job is done.</p>
            </div>
          </div>
        </div>
      </div>

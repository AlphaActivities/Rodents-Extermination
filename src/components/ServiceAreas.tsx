        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div>
            ...
            >
              ...
              <p className="text-neutral-400 text-sm mb-8 sm:mb-10">
            ...
            <div className={`mt-10 pt-8 border-t border-neutral-200 reveal reveal-delay-1 ${chipsVisible ? 'reveal-visible' : ''}`}>
              <p className="text-neutral-500 text-sm">Have questions before reaching out? The most common ones, including what it costs and whether you even need it, are answered just below.</p>
            </div>
          </div>
